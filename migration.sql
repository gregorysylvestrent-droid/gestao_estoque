...
SET
  ...
  telefone = NULLIF(LEFT(COALESCE(NULLIF(BTRIM(telefone), ''), NULLIF(BTRIM(contact), '')), 20), ''),
...
WHERE
  ...
  OR telefone IS DISTINCT FROM NULLIF(LEFT(COALESCE(NULLIF(BTRIM(telefone), ''), NULLIF(BTRIM(contact), '')), 20), '')
